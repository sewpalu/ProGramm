...
struct FormalGrammar
{
  ...
  /**
   * Factory method, choosing a startsymbol from the provided list of nonterminal.
   */
  static FormalGrammar choose_startsymbol(std::vector<Nonterminal*> nonterminals,
